...
import { Heart, Shield, Users, MessageCircle, Search, Star, ArrowRight, Sparkles, Sun, Moon } from 'lucide-react';
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-slate-50 dark:bg-dark-950 transition-colors duration-300">
                {/* Navbar */}
                <nav className="fixed top-0 w-full z-50 bg-white/80 dark:bg-dark-950/80 backdrop-blur-xl border-b border-slate-200 dark:border-dark-800/30">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex justify-between h-16 items-center">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <button
                                    onClick={toggleTheme}
                                    className="p-2 rounded-xl bg-slate-100 text-slate-600 hover:text-primary-500 dark:bg-dark-800/50 dark:text-dark-400 dark:hover:text-primary-400 transition-all duration-300"
                    ...
                    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        <div className="slide-up">
                            <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-primary-500/10 border border-primary-500/20 mb-8">
                                ...
                                <span className="text-primary-600 dark:text-primary-300 text-sm">বাংলাদেশের সবচেয়ে বিশ্বস্ত বিবাহ সেবা</span>
                            </div>

                            <h1 className="text-5xl md:text-7xl font-bold mb-6">
                                <span className="gradient-text">সহজ বিয়ে</span>
                                <br />
                                <span className="text-slate-900 dark:text-dark-100">আপনার জীবনসঙ্গী খুঁজুন</span>
                            </h1>

                            <p className="text-lg md:text-xl text-slate-500 dark:text-dark-400 max-w-2xl mx-auto mb-10 leading-relaxed">
                        ...
                        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                <div key={i} className="glass-card p-6 text-center slide-up" style={{ animationDelay: `${i * 0.1}s` }}>
                                    ...
                                    <div className="text-slate-500 dark:text-dark-400 text-sm">{stat.label}</div>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <section className="py-20">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-dark-100 mb-4">কেন সহজ বিয়ে বেছে নিবেন?</h2>
                            <p className="text-slate-500 dark:text-dark-400 max-w-xl mx-auto">আমাদের প্ল্যাটফর্মে আপনি পাবেন সর্বোচ্চ বিশ্বস্ততা ও নিরাপত্তা</p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {[
                                ...
                                <div key={i} className="glass-card p-8 hover:border-primary-500/30 transition-all duration-500 group slide-up" style={{ animationDelay: `${i * 0.1}s` }}>
                                    ...
                                    <h3 className="text-xl font-semibold text-slate-900 dark:text-dark-100 mb-3">{feature.title}</h3>
                                    <p className="text-slate-500 dark:text-dark-400 leading-relaxed">{feature.desc}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                {/* How It Works */}
                <section className="py-20 bg-slate-100/50 dark:bg-dark-900/30">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-dark-100 mb-4">কিভাবে কাজ করে?</h2>
                        </div>
                        ...
                        <div className="grid md:grid-cols-4 gap-8">
                            {[
                                ...
                                <div key={i} className="text-center slide-up" style={{ animationDelay: `${i * 0.15}s` }}>
                                    ...
                                    <h3 className="text-lg font-semibold text-slate-900 dark:text-dark-100 mb-2">{item.title}</h3>
                                    <p className="text-slate-500 dark:text-dark-400">{item.desc}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        <div className="glass-card p-12 relative overflow-hidden">
                            ...
                            <div className="relative">
                                ...
                                <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-dark-100 mb-4">আজই শুরু করুন আপনার যাত্রা</h2>
                                <p className="text-slate-500 dark:text-dark-400 mb-8 max-w-xl mx-auto">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                            <div className="flex items-center space-x-2">
                                ...
                                <span className="text-slate-600 dark:text-dark-400">সহজ বিয়ে - বাংলাদেশের বিশ্বস্ত বিবাহ সেবা</span>
                            </div>
                            <p className="text-slate-500 dark:text-dark-500 text-sm">© ২০২৪ সহজ বিয়ে। সর্বস্বত্ব সংরক্ষিত।</p>
                        </div>
                    </div>
                </footer>
            </div>
