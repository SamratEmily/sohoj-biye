                ...
                <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        {type === 'received' && proposal.status === 'pending' && (
                            <div className="flex items-center space-x-3 mt-4 pt-3 border-t border-dark-700/30">
                                <button
                                    onClick={() => handleAccept(proposal.id)}
                                    className="flex items-center space-x-2 px-4 py-2 rounded-xl bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 hover:bg-emerald-500/30 transition-all text-sm font-medium"
                                >
                                ...
                                <button
                                    ...
                                    className="flex items-center space-x-2 px-4 py-2 rounded-xl bg-red-500/20 text-red-300 border border-red-500/30 hover:bg-red-500/30 transition-all text-sm font-medium"
                                >
                        ...
                        {proposal.status === 'approved' && proposal.chat_room && (
                            <div className="mt-4 pt-3 border-t border-dark-700/30">
                                <Link
                                    ...
                                    className="flex items-center space-x-2 px-4 py-2 rounded-xl bg-primary-500/20 text-primary-300 border border-primary-500/30 hover:bg-primary-500/30 transition-all text-sm font-medium w-fit"
                                >
